...
export const Teams = () => {
  ...
  const [openedTeamId, setOpenedTeamId] = useState(null);
              ...
              <TableBody>
                {loading ? (
                  ...
                  pageItems.map((t, idx) => {
                    ...
                    const isOpen = openedTeamId === t.teamId;
                    ...
                    return (
                      <>
                        ...
                        <TableRow
                          ...
                          onClick={() => setOpenedTeamId(isOpen ? null : t.teamId)}
                        >
                                ...
                                {t.members?.length ? (
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    {t.members.map((m, i) => (
                                      <div
                                        key={i}
                                        className="flex items-center justify-between rounded border px-3 py-2 text-sm bg-background"
                                      >
                                        <div>
                                          <p className="font-medium">Roll: {m.roll}</p>
